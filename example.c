...
int main(int argc, char* argv[]){
    ...
    my_str_t str_1;
    my_str_create(&str_1, 1);
    my_str_from_cstr(&str_1, example_str, 3);
    printf("Example: %s\n\n", str_1.data);
    ...
    char to_str[] = {'a'};
    my_str_t str_2;
    my_str_from_cstr(&str_2, to_str, 4);
    ...
    my_str_from_cstr(&str_1, example_str, 5);
    printf("Before:\n\tstr: %s\n\tAppend str: %s\n\tmy_str_append\n", str_1.data, str_2.data);
    ...
    printf("Before:\n\tstr: %s\n\tstr.size_m: %zu\n\tstr.capacity: %zu\n\tmy_str_shrink_to_fit\n", str_1.data, str_1.size_m, str_1.capacity_m);
